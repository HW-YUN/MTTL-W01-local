...
- `1.0.106` — `af950833/mttl_w01` 이슈에서 다뤄진 QMS 관련 문제와 연관된 개선
  ...
  검증했습니다.
- `1.0.110` — 이후 투오(tuoway) 님이 공개한 별도의 Standalone(쉬운 설치) 구성용
  커스텀 펌웨어. `1.0.106` 과는 다른 버전이며 동작 구조가 다릅니다. 본 프로젝트는
  `1.0.110` 을 사용하지 않습니다.

자세한 펌웨어 버전 설명은 [docs/firmware-ota.md](docs/firmware-ota.md) 를 참고하세요.
